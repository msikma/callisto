...
mandarake: {
  ...
  main: {
    ...
    searches: [
      ...
      { details: { keyword: 'pokemon', categoryCode: '11' } },
      { details: { keyword: 'pokemon', categoryCode: '07' } },
      { details: { keyword: 'hunterhunter', categoryCode: '11' } },
      { details: { keyword: 'ゼルダの伝説', categoryCode: '01' } },
      { details: { keyword: 'ゼルダの伝説', categoryCode: '11' } }
      // ...
    ]
  },
  auction: {
